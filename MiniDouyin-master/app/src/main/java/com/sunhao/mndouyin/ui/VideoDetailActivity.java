package com.sunhao.mndouyin.ui;
...
import com.sunhao.mndouyin.MyClickListener;
import com.sunhao.mndouyin.R;
import com.sunhao.mndouyin.db.VideoContract;
import com.sunhao.mndouyin.db.VideoDbHelper;
...
public class VideoDetailActivity extends GSYBaseActivityDetail<StandardGSYVideoPlayer> {
    ...
    private String title = "sunhaodemo";
    private String url = "http://test.androidcamp.bytedance.com/mini_douyin/invoke/";
    private String img_url = "https://sf6-hscdn-tos.pstatp.com/obj/developer-baas/baas/tt " +
            "7217xbo2wz3cem41/9c6bbc2aa5355504_1560563154279.jpg";
    private String stu_id = "123456789";
